...
// global provider が staticなので、やむを得ず毎回、自分のインスタンスをセットし直すことで無理やり競合を回避したver.
...
// ゲーム内に1つしか持たないという方法もあるが、UniRx.MessageBroker.Default (Global Scope)と同じことになる（GameManagerに持たせる？）
