...
//----------------------------------------------------------------------------------------------------------------------
        ...
        [FormerlySerializedAs("dynamicRatio")] [SerializeField]
        private float m_dynamicRatio = 1.0f;

        [FormerlySerializedAs("stiffnessForce")] [SerializeField]
        private float m_baseStiffnessForce = 0.01f;

        [FormerlySerializedAs("stiffnessCurve")] [SerializeField]
        private AnimationCurve m_stiffnessScaleCurve
            = AnimationCurve.Constant(0, 1, 1);

        [FormerlySerializedAs("dragForce")] [SerializeField]
        private float m_baseDragForce = 0.4f;

        [FormerlySerializedAs("dragCurve")] [SerializeField]
        private AnimationCurve m_dragScaleCurve
            = AnimationCurve.Constant(0, 1, 1);

        [FormerlySerializedAs("springBones")] [SerializeField]
        internal SpringBone[] m_springBones;
    }
}